Lista de exercícios da matéria de Algorítmo e Lógica de
Programação, da Fatec Zona Leste. Desenvolvido a partir
de uma maquina virtual com OP Linux e comandos git no terminal.
...
20. Receba 3 coeficientes A, B e C de uma equação do 2º grau da fórmula AX² + BX + C = 0. Verifique e mostre a existência de raízes reais e, se existir, calcule e mostre.
...
25. Receba a hora de início e de final de um jogo (HH,MM). Calcule o tempo do jogo em horas e minutos, sabendo que o tempo máximo é menor que 24 horas e pode começar em um dia e terminar no outro.
...
28. Receba o preço atual e a média mensal de vendas de um produto. Calcule e mostre o novo preço sabendo que:
...
29. Receba o tipo de investimento (1 = poupança e 2 = renda fixa) e o valor do investimento. Calcule e mostre o valor corrigido em 30 dias sabendo que a poupança rende 3% e a renda fixa 5%. Demais tipos não serão considerados.

30. Receba a data de nascimento e a data atual em ano, mês e dia. Calcule e mostre a idade em anos, meses e dias, considerando os anos bissextos.
...
35. Receba 2 números inteiros e verifique qual é o maior. Calcule e mostre a somatória dos números ímpares entre esses valores.

36. Receba um número N. Calcule e mostre a série 1 + 1/1! + 1/2! + ... + 1/N!.

37. Receba um número inteiro. Calcule e mostre a série de Fibonacci até o N-ésimo termo.

38. Receba 100 números inteiros reais. Verifique e mostre o maior e o menor valor (considerar apenas valores positivos).
