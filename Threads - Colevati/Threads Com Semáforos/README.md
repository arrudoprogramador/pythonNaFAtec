...
<p>
    <strong>2)</strong> Quatro pessoas caminham, cada uma em um corredor diferente. Os 4 corredores terminam
...
<p>
    <strong>4)</strong> Você foi contratado para automatizar um treino de Fórmula 1. As regras estabelecidas pela
